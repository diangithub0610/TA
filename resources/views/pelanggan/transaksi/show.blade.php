    ...
    $config = $statusConfig[$transaksi->status] ?? [
        ...
        'icon' =>
            'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                                        ...
                                        <div class="flex items-center space-x-2 {{ $config['bg'] }} px-4 py-2 rounded-full font-semibold shadow-sm">
                                                        ...
                                                        <div class="space-y-4">
                                                            ...
                                                            <div class="space-y-3">
                                                                ...
                                                                <div class="flex justify-between">
                                                                    ...
                                                                    <span class="font-medium text-gray-900">{{ $transaksi->pelanggan->no_hp ?? 'N/A' }}</span>
                                                                </div>
                                                                <div class="flex justify-between">
                                                                    <span class="text-gray-600">Email</span>
                                                                    <span class="font-medium text-gray-900">{{ $transaksi->pelanggan->email ?? 'N/A' }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="space-y-4">
                                                            ...
                                                            <div class="space-y-3">
                                                                ...
                                                                <div class="flex justify-between">
                                                                    ...
                                                                    <span
                                                                        class="font-medium text-gray-900">{{ strtoupper($transaksi->pengiriman->ekspedisi ?? 'N/A') }}</span>
                                                                </div>
                                                                <div class="flex justify-between">
                                                                    <span class="text-gray-600">Service</span>
                                                                    <span
                                                                        class="font-medium text-gray-900">{{ strtoupper($transaksi->pengiriman->layanan_ekspedisi ?? 'N/A') }}</span>
                                                                </div>
                                                                <div class="flex justify-between">
                                                                    <span class="text-gray-600">Estimasi</span>
                                                                    <span class="font-medium text-gray-900">
                                                                        {{ \Carbon\Carbon::parse($transaksi->pengiriman->estimasi_tiba ?? null)->translatedFormat('l, j F Y') ?? 'N/A' }}
                                                                    </span>
                                                                ...
                                                                @if ($transaksi->pengiriman && $transaksi->pengiriman->nomor_resi)
                                                                    <div class="flex justify-between">
                                                                        ...
                                                                        <span
                                                                            class="font-mono font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded">{{ $transaksi->pengiriman->nomor_resi }}</span>
                                                                    </div>
                                                                @endif
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                                                <div class="flex-shrink-0">
                                                                    <div
                                                                        ...
                                                                        @if ($detail->detailBarang->barang->gambar ?? false)
